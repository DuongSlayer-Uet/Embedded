...
// core_level
#define UET_NVIC_ISER_BASEADRESS 	0xE000E100U
#define UET_NVIC_ISER0 				(*(volatile uint32_t*)(UET_NVIC_ISER_BASEADRESS + 0X00))		// For EXTI0->9
#define UET_NVIC_ISER1 				(*(volatile uint32_t*)(UET_NVIC_ISER_BASEADRESS + 0X04))		// For EXTI10->15

// peripherals_level
#define UET_EXTI ((UET_EXTI_TypeDef*)0x40010400U)
#define UET_AFIO ((UET_AFIO_TypeDef*)0x40010000U)
