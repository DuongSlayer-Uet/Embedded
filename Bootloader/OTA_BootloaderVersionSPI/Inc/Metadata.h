...
typedef struct
{
	uint32_t activeFirmwareStatus;
	uint32_t oldFirmwareStatus;
	uint32_t trialBootFlag;
	uint32_t trialBootCount;
	uint32_t versionApp1;
	uint32_t versionApp2;
	uint32_t sizeApp1;
	uint32_t sizeApp2;
	uint32_t CRCApp1;
	uint32_t CRCApp2;
	uint32_t app1EntryAddr;
	uint32_t app2EntryAddr;
